...
public class ReactiveUpdater<T> : Reactive<bool>, IDisposable
{
    public ReactiveUpdater(Func<List<T>, bool> func, IReadOnlyReactiveList<T> updater)
    {
        connection = updater.Subscribe(lst =>
        {
