...
namespace UniTools
{
    public static class ListTools
    {
        ...
        {
            return new ReactiveUpdater<T>(lst => lst.Any(element => predicate.Invoke(element)), source);
        }
        public static IReadOnlyReactive<bool> AllReactive<T>(this IReadOnlyReactiveList<T> source, Func<T, bool> predicate)
        {
            return new ReactiveUpdater<T>(lst => lst.All(element => predicate.Invoke(element)), source);
        }
